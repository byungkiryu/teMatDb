...
# df0 = df0[ df0.Temperature >= 300]
# df0 = df0[ df0.Temperature <= 550]
...
if (1):
    ...
    sc = ax.scatter( df[xx], df[yy], c=df[zz], cmap=ccmap,s=symbolsize,
                    vmin = 0)
    ...
    # cbar.set_ticks( list(np.arange(0,10.1,2)) )
...
figure_path  = "FIG_5_TEP_TEP_plots_allTemp/"
