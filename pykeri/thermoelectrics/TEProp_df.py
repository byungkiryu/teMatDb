...
class TEProp:
    ...
    def __init__(self,db_filename=None, id_num=None, color=None):
    ...
    def plot(self, T, **kwargs):
        ...
        y_datas = [('Electrical Conductivity', '[S/cm]', elec_cond *1e-2),
                   ('Electrical Resistivity', r'[$\mu\Omega$ m]', elec_res *1e6),
                   ('Seebeck Coefficient', r'[$\mu$V/K]', seebeck *1e6),
                   ('Thermal Conductivity', '[W/m/K]', thrm_cond),
                   ('Power Factor', r'[mW/m/K$^2$]', seebeck**2*elec_cond *1e3),
