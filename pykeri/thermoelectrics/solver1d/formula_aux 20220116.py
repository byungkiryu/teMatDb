...
def get_zero_V_current(dev):
    ...
    try:
        ...
        # etaMaxGen_fastmode = dev.efficiency
        # gammaGen_fastmode = dev.gamma
        # currentGen_fastmode = dev.I
        ...
        for N_idx in range(10):
            ...
            dev.run_with_given_I(current_ref)
        ...
        # return_dictionary['V_over_Vgen_at_Imax'] = (V_near_root/dev.Vgen).copy()
