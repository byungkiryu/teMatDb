...
st.markdown("- High quality thermoelectric (TE) database (DB), teMatDb (ver1.1.5)")
...
file_tematdb_metadata_csv = "_tematdb_metadata_v1.1.6-20250224.xlsx"
file_tematdb_db_csv       =  "tematdb_v1.1.6_completeTEPset.csv"
file_tematdb_db_exTEP_csv = "tematdb_v1.1.6_extendedTEPset.csv"
filepath_tematdb_csv = "./data_csv/"+file_tematdb_db_csv
# df_db_csv_tematdb =  load_csv(filepath_tematdb_csv)
...
#         # filepath_tematdb_csv = "./data_csv/"+file_tematdb_db_csv
#         # df_db_csv_tematdb =  load_csv(filepath_tematdb_csv)
#         df_db_csv = df_db_csv_tematdb
        
#         df_db_extended_csv = pd.read_csv("./data_csv/"+file_tematdb_db_exTEP_csv )
...
#         file_tematdb_metadata_csv = "_Starrydata2_20250201__tep_metadata__20250211_003906.xlsx"      
#         df_db_meta0 = pd.read_excel("./"+file_tematdb_metadata_csv, sheet_name='_Starrydata2_20250201__tep_meta', )
#         df_db_meta0['sampleid'] =df_db_meta0['sample_id']
        
#         df_db_meta = df_db_meta0
#         df_db_meta.index = list(df_db_meta.sampleid.copy())
        
     
#         df_alpha0 = pd.read_feather("./data_csv/"+"20250201_rawdata_alpha.feather")
#         df_rho0   = pd.read_feather("./data_csv/"+"20250201_rawdata_rho.feather")
#         df_kappa0 = pd.read_feather("./data_csv/"+"20250201_rawdata_kappa.feather")
#         df_ZT0    = pd.read_feather("./data_csv/"+"20250201_rawdata_ZT.feather")
        
#         df_alpha0['sampleid']     = df_alpha0['sample_id'] 
#         df_rho0['sampleid']       = df_rho0['sample_id'] 
#         df_kappa0['sampleid']     = df_kappa0['sample_id'] 
#         df_ZT0['sampleid']        = df_ZT0['sample_id'] 
...
#         df_db_extended_csv = pd.read_feather("./data_csv/"+"Starrydata2_extendedTEPset_2K__20250210_110254.feather" )
#         df_db_extended_csv = df_db_extended_csv[ df_db_extended_csv.is_Temp_in_autoTcTh_range ]
#         df_db_extended_csv = df_db_extended_csv[ df_db_extended_csv.is_Temp_in_ZT_author_declared ] 
