...
df_starry_meta0 = pd.read_excel(PATH_metadata, sheet_name='starrydata_dataset_250501-0300', )       
...
df_alpha0 = pd.read_feather(PATH_tep_feather+f"{prefix}_alpha.feather")
df_rho0   = pd.read_feather(PATH_tep_feather+f"{prefix}_rho.feather")
df_kappa0 = pd.read_feather(PATH_tep_feather+f"{prefix}_kappa.feather")
df_ZT0    = pd.read_feather(PATH_tep_feather+f"{prefix}_ZT.feather")
